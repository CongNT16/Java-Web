...
<html lang="en">
    <head>
        ...
        <title>Cozzy | Book ticket web</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="nav">
                <a href="#" class="logo">
                    <i style="margin-right: 10px;" class='bx bx-movie-play bx-tada main-color'></i>Co<span class="main-color">zz</span>y
                </a>
                ...
                <div class="nav-sign">
                    ...
                    <a href="book1.jsp" class="btn btn-hover">
                ...
                <div class="w3-dropdown-hover">
                    ...
                    <div class="w3-dropdown-content w3-bar-block w3-border">
                        <a href="changePass.jsp" class="w3-bar-item w3-button">Change Password</a>
    ...
    <div class="section" id="latest-section">
        <div class="section-wrapper" id="section-wrapper">
            ...
            <div class="movies-slide row">
                ...
                <a href="book1.jsp" class="movie-item col-3-5 m-5 s-11 to-top show-on-scroll">
                    <div>
