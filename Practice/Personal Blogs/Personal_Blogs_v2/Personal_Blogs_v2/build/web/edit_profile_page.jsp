                ...
                <div class="container-profile">
                    ...
                    <div class="info-user">
                        <div class="avatar-user">
                            <input name="userid" value="${sessionScope.user_infor_id}" hidden>
                        ...
                        <div class="main-info">
                            <h1>Profile 
                                <div class="text-edit"><a href="">Edit <i class='bx bxs-edit'></a></i></div></h1>
                                ...
                                <form action="EditProfileController" method="post">
                                    <table style="border-spacing:30px 0;">
                                        ...
                                        <div class="useraccount">
                                            ...
                                            <td>
                                                <input type="text" name="user_edit_account" >
                                            </td>
                                        ...
                                        <div class="username">
                                            ...
                                            <td>
                                                <input type="text" name="user_edit_name" >
                                        ...
                                        <div class="usergender">
                                            ...
                                            <td>
                                                <input type="radio" name="user_edit_gender" value="1">Male 
                                        ...
                                        <div class="userdob">
                                            ...
                                            <td>
                                                <input type="text" name="user_edit_dob" >
                                            </td>
                                        ...
                                        <div class="useremail">
                                            ...
                                            <td>
                                                <input type="text" name="user_edit_email" >
                                            </td>
                                        ...
                                        <div class="userphone">
                                            ...
                                            <td>
                                                <input type="text" name="user_edit_phone" >
                                            </td>
                                        ...
                                        <div class="useraddress">
                                            ...
                                            <td>
                                                <input type="text" name="user_edit_address" >
                                            </td>
