                                        ...
                                        <table class="table table-striped" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col"  style="width: 30%">User Account</th>
                                                    <th scope="col"  style="width: 30%">User Role</th>
                                            ...
                                            <c:forEach items="${listUser}" var="user" varStatus="count">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a onclick="delWithUsercId(${user.getUser_id()})"><i class="uil uil-trash-alt"></i></a></td>
                                    ...
                                    <div class="create-card-group" style="margin: auto; background:  white; margin-top: 50px; overflow-y: auto;">
                                        ...
                                        <form action="ManageUsersController" method="get">
                                            ...
                                            <table class="table " >
                                                ...
                                                <tr>
                                                    <td >Password</td>
                                                    <td><input type="text" name="user_password1"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:forEach items="${listRole}" var="role">
                                                            <input type="radio" name="role_id" value="${role.getRole_id()}" > ${role.getRole_name()}
                                                        </c:forEach>
                                                    </td>
                                                </tr>
