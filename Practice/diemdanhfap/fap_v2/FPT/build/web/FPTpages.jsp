        ...
        <div class="row">
            ...
            <div class="col-md-9" style="background-color: #f7f6f9 ; padding: 30px ">
                ...
                <div style="float: right">
                    <table >
                        <c:if test="${sessionScope.enroll eq 'admin'}">
                        <button  type="button" class="btn btn-success h-15 pt-0 me-1 ms-1 mt-1"  style="height: 20px; ;font-size: 12px; background-color: rgb(92,184,92);">  <a href="Adminpages.jsp"  target="target" style="color: white" > Manager </a> </button>|
                        </c:if>
