...
public class TagController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String gettagid = req.getParameter("gettagid");
        ...
        Tags tagWithId = tg.getTagWithTagId(gettagid);
        req.setAttribute("tagName", tagWithId.getTag_name());
        req.setAttribute("tagID", tagWithId.getTag_id());
