<%-- 
    Document   : tag
    Created on : Nov 1, 2022, 11:07:56 AM
    Author     : nguye
--%>
            ...
            <div class="main">
                ...
                <div class="container" style="display: block">
                    ...
                    <div class="blog">
                        ...
                        <h2 class="h2">${tagName}</h2>

                        <div class="blog-card-group">


                            <c:forEach items="${listPost}" var="post" >
                                <c:forEach items="${listPostTag}" var="posttag">
                                    <c:if test="${posttag.getTag_id() eq tagID}">


                                        <c:if test="${post.getPost_id() eq posttag.getPost_id()}">
                                            <div class="blog-card">
